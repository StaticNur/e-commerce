...
@Repository
public class ApartmentDAO implements DataDAO {
    private JdbcTemplate jdbcTemplate;

    public void save(List<Attribute> data) {
        String INSERT_QUERY = "INSERT INTO RUSSIAN_ADDRESS_DATA.APARTMENT (id, object_id, object_guid, change_id, number, apart_type, oper_type_id, prev_id, next_id, update_date, start_date, end_date, is_actual, is_active) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        //jdbcTemplate.batchUpdate(INSERT_QUERY, data, new int[] {Types.BIGINT, Types.BIGINT, Types.VARCHAR, Types.BIGINT, Types.VARCHAR, Types.INTEGER, Types.BIGINT, Types.BIGINT, Types.BIGINT, Types.DATE, Types.DATE, Types.DATE, Types.INTEGER, Types.INTEGER});
        jdbcTemplate.batchUpdate(INSERT_QUERY, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                ...
                ps.setInt(6, Integer.parseInt(row.getAttributesByKey("APARTTYPE")));
