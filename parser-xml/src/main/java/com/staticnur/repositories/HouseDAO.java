...
public class HouseDAO implements DataDAO {
    ...
    public void save(List<Attribute> data) {
        ...
        //jdbcTemplate.batchUpdate(INSERT_QUERY, data, new int[] {Types.BIGINT, Types.BIGINT, Types.VARCHAR, Types.BIGINT, Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.INTEGER, Types.INTEGER, Types.INTEGER, Types.BIGINT, Types.BIGINT, Types.BIGINT, Types.DATE, Types.DATE, Types.DATE, Types.INTEGER, Types.INTEGER});
